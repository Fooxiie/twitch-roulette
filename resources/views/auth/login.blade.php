<x-guest-layout>
    <x-auth-card>
        ...
        <h1 class="text-xl font-bold text-gray-500">Connecte toi pour entrer dans le casino</h1><br />
        ...
        <a href="{{route('auth.twitch.redirect')}}" class="rounded bg-gray-800 text-white flex py-2 px-4 text-xl justify-center w-auto">

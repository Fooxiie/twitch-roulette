<x-app-layout>
    ...
    <div class="mx-auto w-1/2 my-12 py-4 px-4 rounded text-gray-200 bg-gray-800 justify-center shadow-2xl">
        <form action="{{route('room.submit')}}" method="get">
            ...
            <input class="rounded text-black" required type="number" id="room_places" name="room_places"/>
            <br/><br/>
            <input type="submit"/>
        </form>
    </div>
